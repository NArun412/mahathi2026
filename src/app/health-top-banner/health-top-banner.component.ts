...
@Component({
  selector: 'app-health-top-banner',
  templateUrl: './health-top-banner.component.html',
  styleUrls: ['./health-top-banner.component.css']
})
export class HealthTopBannerComponent {
